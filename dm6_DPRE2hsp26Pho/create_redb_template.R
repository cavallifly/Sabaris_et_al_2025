...
dbDir <- '/zdata/data/mishaDB/trackdb/XXXmutationXXX/'
...
if(length(gtrack.ls(restrictionSeq)) < 1)
{
    ...
    gtrack.create_mapab_track(paste0("/zdata/data/2024_01_08_HiC_Sandrine2/00_build_the_XXXmutationXXX_modified_genome/mapa_",checkSp,".config"))
    # Second one as to creat the restriction enzyme database track
    #gtrack.create_redb_tracks(restrictionSeq,paste0('/zdata/data/2024_01_08_HiC_Sandrine2/00_build_the_XXXmutationXXX_modified_genome/redb_',checkSp,'.conf'),verbose=TRUE)
}
