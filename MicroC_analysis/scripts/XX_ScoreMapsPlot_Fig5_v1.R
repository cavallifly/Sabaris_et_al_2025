...
for(annotated in c("FALSE","TRUE"))
{
	...
	outFile = paste0("scoreMapsk",k,"kexp",kexp,"_",chr,"_",start,"bp_",end,"bp_r",res,"bp_Fig5_annot_",annotated,".png")
	if(file.exists(outFile)){next;}
	png(file=paste0("scoreMapsk",k,"kexp",kexp,"_",chr,"_",start,"bp_",end,"bp_r",res,"bp_Fig5_annot_",annotated,".png"),width=nc*slotSize,height=nr*slotSize)	
	...
	for(set in names(scoreData))
	{
	    ...
	    data[is.na(data)] <- 0
	    outMatrix <- paste0("scoreMapsk",k,"kexp",kexp,"_",chr,"_",start,"bp_",end,"bp_r",res,"bp_Fig5_",set,".tsv")
	...
	png(file=paste0("scoreMapsk",k,"kexp",kexp,"_",chr,"_",start,"bp_",end,"bp_r",res,"bp_Fig5_annot_",annotated,"_toModify.png"),width=nc*slotSize,height=nr*slotSize)
...
pdf(paste0('scores_colorbar_Fig5.pdf'),width=8,height=8)
