...
for file in $(ls -1 ${files}) ;
do
    #name=$(echo $file | sed "s/_/ /g" | awk '{print $5"_"$6}' | sed -e "s/pre2NetA//g" -e "s/GAGA//g" -e "s/DPRE2_/ΔPRE2/g" -e "s/DPRE2hsp26Pho_/Hsp26+3xPHO/g" -e "s/DPRE2hsp26_/Hsp26/g" -e "s/DWT_/WT/g")
...
for file in $(ls -1 ${files}) ;
do
    #name=$(echo $file | sed "s/_/ /g" | awk '{print $5"_"$6}' | sed -e "s/pre2en//g" -e "s/GAGA//g" -e "s/DPRE2_/ΔPRE2/g" -e "s/DPRE2hsp26Pho_/Hsp26+3xPHO/g" -e "s/DPRE2hsp26_/Hsp26/g" -e "s/DWT_/WT/g")
