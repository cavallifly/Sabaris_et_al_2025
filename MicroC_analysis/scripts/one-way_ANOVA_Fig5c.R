...
inFiles = c("scoreMapsk250kexp500_r3000bp_dac_Fig5c.tsv")
print(inFiles)
#quit()
...
for(inFile in inFiles)
{
    ...
    custom_pairs <- list(c("WT","DPRE2"),c("WT","Vir"),c("WT","2xPRE1"),c("DPRE2","Vir"),c("DPRE2","2xPRE1"),c("Vir","2xPRE1"))
    print(custom_pairs)
    #quit()
