...
insTracks <- list(
        ED_PH18_100    = 'insulation.INS_microc_ED_PH18_merge_dm6_BeS_w100kb_r2kb',
        ED_PH18_150    = 'insulation.INS_microc_ED_PH18_merge_dm6_BeS_w150kb_r2kb',
        ED_PH18_200    = 'insulation.INS_microc_ED_PH18_merge_dm6_BeS_w200kb_r2kb',
        ED_PH18_250    = 'insulation.INS_microc_ED_PH18_merge_dm6_BeS_w250kb_r2kb',
        ED_PH18_300    = 'insulation.INS_microc_ED_PH18_merge_dm6_BeS_w300kb_r2kb',	
	ED_PH29_100 = 'insulation.INS_microc_ED_PH29_merge_dm6_BeS_w100kb_r2kb',
	ED_PH29_150 = 'insulation.INS_microc_ED_PH29_merge_dm6_BeS_w150kb_r2kb',
	ED_PH29_200 = 'insulation.INS_microc_ED_PH29_merge_dm6_BeS_w200kb_r2kb',
	ED_PH29_250 = 'insulation.INS_microc_ED_PH29_merge_dm6_BeS_w250kb_r2kb',
	ED_PH29_300 = 'insulation.INS_microc_ED_PH29_merge_dm6_BeS_w300kb_r2kb'
        )
refSet = "ED_PH18"
...
for(set in names(insTracks))
{
    ...
    trackName  <- gsub("_microc","",gsub("_merge_dm6_SD","",gsub("_merge_dm6_BeS","",gsub("insulation.","",set))))
...
for(trackName in names(insData))
{
    ...
    outProfile <- paste0("insulationProfiles_Fig1D_",trackName,"_phKD.tsv")
...
for(set in names(insData))
{
    ...
    if(set == "ED_PH29")
    {
        pdf(paste0("insulationProfiles_Fig1D_phKD.pdf"),width=19,height=7)    
