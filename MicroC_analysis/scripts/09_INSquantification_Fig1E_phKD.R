...
insTracks <- list(
	ED_PH18 = 'insulation.INS_microc_ED_PH18_merge_dm6_BeS_w100kb_r2kb',
	ED_PH29 = 'insulation.INS_microc_ED_PH29_merge_dm6_BeS_w100kb_r2kb'
        )
...
pdf('insulation_quantifications_Fig1E_phKD.pdf',width=12,height=9)
