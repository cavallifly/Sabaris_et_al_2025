...
inFiles = c("scoreMapsk250kexp500_r3000bp_dac_Fig4f.tsv","scoreMapsk250kexp500_r3000bp_NetA_Fig4fControl.tsv","scoreMapsk250kexp500_r3000bp_en_Fig4fControl.tsv")
print(inFiles)
#quit()
...
levels = c("WT","DPRE2","Hsp26","Hsp26+3xPHO")
