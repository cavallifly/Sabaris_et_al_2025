...
zmax <-  100
scoreData <- list(
        ED_PH18 = paste0("microC.mCScores_ED_PH18_merge_dm6_BeS.mCScores_ED_PH18_merge_dm6_BeS_chr2L_0_23513712bp_score_k",k,"_kexp",kexp,"_step1Mb"),
        ED_PH29 = paste0("microC.mCScores_ED_PH29_merge_dm6_BeS.mCScores_ED_PH29_merge_dm6_BeS_chr2L_0_23513712bp_score_k",k,"_kexp",kexp,"_step1Mb")	
        )
...
for(annotated in c("FALSE","TRUE"))
{
	...
	png(file=paste0("scoreMapsk",k,"kexp",kexp,"_",chr,"_",start,"bp_",end,"bp_r",res,"bp_Fig1C_annot_",annotated,"_phKD.png"),width=nc*slotSize,height=nr*slotSize)
	...
	png(file=paste0("scoreMapsk",k,"kexp",kexp,"_",chr,"_",start,"bp_",end,"bp_r",res,"bp_Fig1C_annot_",annotated,"_toModify_phKD.png"),width=nc*slotSize,height=nr*slotSize)
