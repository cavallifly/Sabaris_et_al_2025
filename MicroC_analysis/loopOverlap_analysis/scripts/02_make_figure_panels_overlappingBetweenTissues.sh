...
for panel in overlappingLoopsBetweenTissues ;
do
    ...
    bash ../../scripts_clean/03_plot_matrix_comparison_between_groups_${panel}.sh ${minDist} ${maxDist} &> 03_plot_matrix_comparison_between_groups_${panel}.out
    ls -lrtha
