...
inFiles = list.files("./",pattern=".*_range4_res250_peScan_centralRegion_8pixels_heatmaps_data.txt.*")
print(inFiles)
#quit()
...
# Using Generic RGB
colors=c(rgb( 0,   0,    225, 1.0, names = NULL, maxColorValue = 255), rgb( 83, 83, 83, 1.0, names = NULL, maxColorValue = 255), rgb( 0,   0,    225, 1.0, names = NULL, maxColorValue = 255), rgb( 83, 83, 83, 1.0, names = NULL, maxColorValue = 255), rgb( 0,   0,    225, 1.0, names = NULL, maxColorValue = 255), rgb( 83, 83, 83, 1.0, names = NULL, maxColorValue = 255))
#print(head(data))
...
for(inFile in inFiles)
{
    ...
    custom_pairs <- list(c("All_Control", "All_PH_KD"), c("noPcG_Control", "noPcG_PH_KD"), c("PcG_Control", "PcG_PH_KD"))
    #print(custom_pairs)
    #quit()
