...
#inFiles = list.files("./",pattern="scoreMapsk250kexp500_r3000bp_.*_Fig2.*.tsv.*")
inFiles = c("scoreMapsk250kexp500_r3000bp_dac_Fig2d.tsv", "scoreMapsk250kexp500_r3000bp_NetANetB_Fig2f.tsv")
print(inFiles)
#quit()
...
# Using Generic RGB
colors=c(rgb( 0,   0,    0, 20, names = NULL, maxColorValue = 255), rgb( 91,  26, 142, 20, names = NULL, maxColorValue = 255), rgb(178, 178, 178, 20, names = NULL, maxColorValue = 255), rgb(251,   0,   6, 20, names = NULL, maxColorValue = 255))
#print(head(data))

levels = c("WT","(GA)n_mut2","(GA)n_mut4","(GA)n_mut6")
...
for(inFile in inFiles)
{
    ...
    custom_pairs <- list(c("WT", "(GA)n_mut2"), c("WT", "(GA)n_mut4"), c("WT", "(GA)n_mut6"))
    print(custom_pairs)
    #quit()
	...
	significantInteraction = res.aov$p
	if(significantInteraction < 0.05)
	{
