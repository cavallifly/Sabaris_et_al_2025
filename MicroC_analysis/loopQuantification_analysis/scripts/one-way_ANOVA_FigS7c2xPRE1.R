...
inFiles = list.files("./",pattern="scoreMapsk250kexp500_r3000bp_.*_FigS7c.tsv.*")
...
# Using Generic RGB
colors=c(rgb( 83,   83,    83, 20, names = NULL, maxColorValue = 255), rgb(83,   83,   83, 20, names = NULL, maxColorValue = 255), rgb(83, 83, 83, 20, names = NULL, maxColorValue = 255), rgb( 0,  0, 255, 20, names = NULL, maxColorValue = 255), rgb( 83,  83, 83, 20, names = NULL, maxColorValue = 255), rgb( 83,  83, 83, 20, names = NULL, maxColorValue = 255))
#print(head(data))
...
for(inFile in inFiles)
{
    ...
    outFile <- paste0("violinPlot_",name,"_2xPRE1.pdf")
    pdf(outFile)
    print(bxp)
    dev.off()
    #quit()
    ...
    outFile <- paste0("violinPlot_",name,"_2xPRE1_with_stats.pdf")
    pdf(outFile)
    print(finalBxp)
    dev.off()	
    #quit()
