...
do
    ...
    rsync -avz ../distPEscan_mC_*_minDist${minDist}_maxDist${maxDist}*/RData/distPEscan_mC_*FC2_${peak}*peScan_text.mtx .
    rsync -avz ../distPEscan_mC_*_minDist${minDist}_maxDist${maxDist}*/RData/distPEscan_mC_*q*_${peak}*peScan_text.mtx .
    ...
    do
	echo $file
	quartile=$(echo $file | sed "s/_/ /g" | awk '{print $10}' | sed "s/q/Q/g")
	#quartile=$(echo $file | sed "s/_/ /g" | awk '{print $7}' | sed "s/q/Q/g")	
	echo $quartile
...
Rscript ../scripts/03_violinPlots_within_quartiles_scores_Fig1cd.R 0
